...
const spread = require('spread-args');
const spreadSeries = spread(hoi.series);
...
class BemGraph {
    ...
    dependenciesOf(entities, tech) {
        ...
        const iter = series.apply(null, vertices.map(vertex => this._dependenciesOf(vertex)));
        ...
        return arr.map(vertex => {
            ...
            vertex.tech && (obj.tech = vertex.tech);
